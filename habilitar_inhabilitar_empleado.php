            ...
            <div class="yellow_bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="title">
                                <h2>habilitar/inhabilitar empleado</h2>
            ...
            <div id="contact" class="contact">
                <div class="container">
                    <div class="row">
                        <div class=" col-md-12">
                            <div class="title">
                                <h2>habilitar<strong class="white"> inhabilitar empleados</strong></h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <form class="main_form">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <input class="form-control" style ="background-color:transparent" placeholder="Identificacion del empleado" type="number" name="id" required="true">
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <label for="lang"><h2>Estado del empleado</h2></label>
                                        <select name="Estado" id="Estado">
                                          <option value="Administrador">habilitar</option>
                                          <option value="Cliente">inhabilitar</option>
