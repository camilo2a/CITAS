            ...
            <div id="contact" class="contact">
                <div class="container">
                    <div class="row">
                        <div class=" col-md-12">
                            <div class="title">
                                <h2>Reporte d<strong class="white">e cita</strong></h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <form class="main_form">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <input class="form-control" style ="background-color:transparent" placeholder="id de la cita" type="number" name=" Date" required="true">
                                </div>
                                   
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <textarea class="textarea" style ="background-color:transparent" placeholder="comentarios de la cita" type="text" name="Message" required="true"></textarea>
                                    </div>
                                </div>
