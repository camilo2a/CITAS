            ...
            <div id="contact" class="contact">
                <div class="container">
                    <div class="row">
                        <div class=" col-md-12">
                            <div class="title">
                                <h2>Registrar<strong class="white"> usuario</strong></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <form id="frm-usuario" action="../Controlador/registrar_usuario.php" method="post" enctype="multipart/form-data">
                                <div class="row">

                                    
                                   
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <input class="form-control" style ="background-color:transparent" placeholder="Correo del usuario" type="email" name="correoUsuario" required="true">
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <input class="form-control" style ="background-color:transparent" placeholder="Contraseña del usuario" type="password" name="passwordUsuario" required="true">
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <input class="form-control" style ="background-color:transparent" placeholder="Activo / Inactivo" type="text" name="estadoUsuario" required="true">
                                    </div>
