        ...
        <div class="sidebar">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="contact.html">Registrarse/Iniciar sesion</a>
                    </li>
                </ul>
            ...
            <div class="yellow_bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="title">
                                <h2>Bienvenidos al salon Nelson Marin</h2>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="about_box">
                                ...
                                <p>El Salón de Belleza Nelson Marin  cuenta con servicios de cepillado, tinte, corte de cabello, manicura y pedicura, entre otros. El salón de belleza cuenta con un administrador y empleados que realizan las diferentes actividades relacionadas con los servicios.</p>
