...
<body class="main-layout">
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <center><h1>Gestion de servicios</h1></center> 
            <li class="button"><a href="registrar_servicio.php" >Registrar servicio</a></li> <br>
            <li class="button"><a href="actualizar_servicio.php">Actualizar servicio</a></li> <br> 
            <li class="button"><a href="consultar_servicio.php">consultar servicio</a> </li><br> 
            <li class="button"><a href="habilitar_inhabilitar_servicio.php">Habilitar/inhabilitar servicio</a></li> <br> 
