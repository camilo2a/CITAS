...
<body class="main-layout">
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <li class="button"><a href="registrar_empleado.php" >Registrar empleado</a> </li> <br>
            <li class="button"><a href="actualizar_empleado.php">Actualizar empleado</a> </li> <br> 
            <li class="button"><a href="consultar_empleado.php">Consultar empleado</a> </li> <br> 
            <li class="button"><a href="habilitar_inhabilitar_empleado.php">Habilitar/inhabilitar empleado</a> </li> <br> 
