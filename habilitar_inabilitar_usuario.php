            ...
            <div id="contact" class="contact">
                <div class="container">
                    <div class="row">
                        <div class=" col-md-12">
                            <div class="title">
                                <h2>habilitar<strong class="white"> inhabilitar usuarios</strong></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <form id="frm_usuario" action="../Controlador/Eliminar_Usuario.php" method="POST" enctype="multipart/form_data">
                                <div class="row">
                                    <H1>Esta apunto de eliminar un usuario ¿desea continuar?</H1>
