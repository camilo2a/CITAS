...
<body class="main-layout">
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <li class="button"><a href="registrar_usuario.php" >Registrar usuario</a> </li><br> 
            <li class="button"><a href="actualizar_usuario.php">actualizar usuario</a> </li><br> 
            <li class="button"><a href="consultar_usuario.php">consultar usuario</a> </li><br> 
            <li class="button"><a href="habilitar_inabilitar_usuario.php">Habilitar/inhabilitar usuario</a> </li><br> 
