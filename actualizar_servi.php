            ...
            <div id="contact" class="contact">
                <div class="container">
                    <div class="row">
                        <div class=" col-md-12">
                            <div class="title">
                                <h2>Actualizar<strong class="white"> servicio</strong></h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <form class="main_form">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <input class="form-control" style ="background-color:transparent"placeholder="id del servicio" type="number" name="nombre" required>
                                    </div>
                                    
                                   
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <textarea class="textarea" style ="background-color:transparent"placeholder="Descripcion del servicio" type="text" name="Message" required></textarea>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
