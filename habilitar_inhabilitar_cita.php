            ...
            <div class="yellow_bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="title">
                                <h2>habilitar/inabilitar cita</h2>
            ...
            <div id="contact" class="contact">
                <div class="container">
                    <div class="row">
                        <div class=" col-md-12">
                            <div class="title">
                                <h2>habilitar/inhabilitar<strong class="white"> cita</strong></h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <form class="main_form">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <input class="form-control" style ="background-color:transparent"placeholder="Identificacion de la cita" type="number" name="id" required="true">
                                    </div>
