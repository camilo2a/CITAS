...
<body>
    ...
    <div class="wrapper"> <!--se utiliza para agrupar y contener el contenido principal de la página web, ayudando a mantener un diseño organizado y estructurado-->
        ...
        <div id="content"> <!-- se utiliza para definir una sección de contenido principal en una página web-->
            ...
            <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 text-center">
                            <a class="btn btn-primary" href="registrar_usuario.php">Registrar Usuario</a>
                       </div>
        ...
        <tr>
            ...
            <td>
                <a href="habilitar_inabilitar_usuario.php?idUsuario=<?php echo $r['idUsuario']; ?>">eliminar</a><!-- INDICA QUE CONTROLADOR Y QUE ACCION EJECUTAR, EN ESTE CASO LLAMARIA AL ARCHIVO ELIMINARUSUARIO.PHP PASANDO EL ID COMO PARÁMETRO--->
            </td>
        </tr>
        <?php
        }
