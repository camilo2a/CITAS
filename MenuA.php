...
<body class="main-layout">
    <div class="container">
    <div class="well well-sm text-center"><?php require_once('../Modelo/Login.php');
    $ModelLogin=new Login();
    $ModelLogin->validateSession();
    ?></div>
</div>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <li class="button"><a href="Usuarios.php">Gestionar Usuarios</a> </li>
            <li class="button"><a href="gestion_empleados.php">Gestionar empleados</a></li>
            <li class="button"><a href="gestion_citas.php">Gestrionar citas</a> </li>
            <li class="button"><a href="gestion_servicios.php">Gestrionar servicios</a>  </li>
            <li class="button"><a href="reporte_citas.php">Generar reporte de citas</a> </li>
