            ...
            <div class="yellow_bg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="title">
                                <h2>consultar</h2> <h2>servicio</h2>
            ...
            <div id="contact" class="contact">
                <div class="container">
                    <div class="row">
                        <div class=" col-md-12">
                            <div class="title">
                                <h2>consultar <strong class="white">servicio</strong></h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <form class="main_form">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <input class="form-control" style ="background-color:transparent"placeholder="id del servicio" type="number" name="id" required>
                                    </div>
                                    
                                    
                                    
                                    <li class="button"> 
                                        <a href="consultar_servi.php">   Enviar</a>
                                    </li>
                                </div>
                            </form>
                            <br>
